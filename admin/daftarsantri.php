    ...
    <div class="panel-body">
      ...
      <!-- Text input-->
          ...
          <div class="form-group">
            ...
            <div class="col-md-4">
              <input id="tempatlahir" name="tempatlahir" type="text" placeholder="" class="form-control input-md"
                required="">
          ...
          <div class="form-group">
            ...
            <div class="col-md-4">
              <input id="namasekolah" name="namasekolah" type="text" placeholder="" class="form-control input-md"
                required="">
          ...
          <div class="form-group">
            ...
            <div class="col-md-4">
              <input id="kabupaten" name="kabupaten" type="text" placeholder="" class="form-control input-md"
                required="">
          ...
          <div class="form-group">
            ...
            <div class="col-md-4">
              <input id="kecamatan" name="kecamatan" type="text" placeholder="" class="form-control input-md"
                required="">
              ...
              <form class="form-horizontal">
                <fieldset>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-4">
                      <input id="namalengkapayah" name="namalengkapayah" type="text" placeholder=""
                    ...
                    <div class="col-md-4">
                      <div class="radio">
                        <label for="pekerjaanayah-0">
                          <input type="radio" name="pekerjaanayah" id="pekerjaanayah-0" value="Wiraswasta"
                            checked="checked">
                          Wiraswasta
                        </label>
                      </div>
                    ...
                    <div class="col-md-4">
                      <div class="radio">
                        <label for="penghasilanayah-0">
                          <input type="radio" name="penghasilanayah" id="penghasilanayah-0" value="1 - 3 Juta"
                            checked="checked">
                          1 - 3 Juta
                        </label>
                      </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-4">
                      <input id="kecamatanayah" name="kecamatanayah" type="text" placeholder=""
                        class="form-control input-md">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-4">
                      <input id="kabupatenayah" name="kabupatenayah" type="text" placeholder=""
                        class="form-control input-md">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-4">
                      <input id="provinsiayah" name="provinsiayah" type="text" placeholder=""
                        class="form-control input-md">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-4">
                      <input id="nowhatsappayah" name="nowhatsappayah" type="text" placeholder=""
                        class="form-control input-md">
            ...
            <div class="panel-body">
              <fieldset>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                    <input id="namalengkapibu" name="namalengkapibu" type="text" placeholder=""
                      class="form-control input-md">
                  ...
                  <div class="col-md-4">
                    <div class="radio">
                      <label for="pekerjaanibu-0">
                        <input type="radio" name="pekerjaanibu" id="pekerjaanibu-0" value="Ibu Rumah Tangga"
                          checked="checked">
                        Ibu Rumah Tangga
                      </label>
                    </div>
                  ...
                  <div class="col-md-4">
                    <div class="radio">
                      <label for="penghasilanibu-0">
                        <input type="radio" name="penghasilanibu" id="penghasilanibu-0" value="1 - 3 Juta"
                          checked="checked">
                        1 - 3 Juta
                      </label>
                    </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                    <input id="kecamatanibu" name="kecamatanibu" type="text" placeholder=""
                      class="form-control input-md">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                    <input id="kabupatenibu" name="kabupatenibu" type="text" placeholder=""
                      class="form-control input-md">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                    <input id="nowhatsappibu" name="nowhatsappibu" type="text" placeholder=""
                      class="form-control input-md">
          ...
          <div id="formwali" style="">
            ...
            <div class="panel-body">
              ...
              <div class="form-group">
                ...
                <div class="col-md-4">
                  <input id="namalengkapwali" name="namalengkapwali" type="text" placeholder=""
                    class="form-control input-md">
              ...
              <div class="form-group">
                ...
                <div class="col-md-4">
                  <input id="tempatlahirwali" name="tempatlahirwali" type="text" placeholder=""
                    class="form-control input-md">
                ...
                <div class="col-md-4">
                  <div class="radio">
                    <label for="pekerjaanwali-0">
                      <input type="radio" name="pekerjaanwali" id="pekerjaanwali-0" value="Ibu Rumah Tangga"
                        checked="checked">
                      Ibu Rumah Tangga
                    </label>
                  </div>
                ...
                <div class="col-md-4">
                  <div class="radio">
                    <label for="penghasilanwali-0">
                      <input type="radio" name="penghasilanwali" id="penghasilanwali-0" value="1 - 3 Juta"
                        checked="checked">
                      1 - 3 Juta
                    </label>
                  </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-4">
                  <input id="kecamatanwali" name="kecamatanwali" type="text" placeholder=""
                    class="form-control input-md">
              ...
              <div class="form-group">
                ...
                <div class="col-md-4">
                  <input id="kabupatenwali" name="kabupatenwali" type="text" placeholder=""
                    class="form-control input-md">
              ...
              <div class="form-group">
                <label class="col-md-4 control-label" for="nowhatsappibu">No. Whatsapp</label>
                <div class="col-md-4">
                  <input id="nowhatsappwali" name="nowhatsappwali" type="text" placeholder=""
                    class="form-control input-md">
